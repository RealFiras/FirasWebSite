...
const ProjectCard = React.memo(function ProjectCard({ project, onClick }: { project: ProjectItem; onClick?: () => void }) {
    return (
        <BlurReveal>
            <div
                onClick={project.title ? onClick : undefined}
                className={`group relative w-full xl:w-[45vw] aspect-4/3 shrink-0 xl:mx-6 perspective-1000 ${project.title ? "cursor-pointer" : "cursor-default"}`}
            >
